...
/// Creates an native rust 'preinitialize' instruction.
...
/// Creates an native rust 'initialize' instruction.
pub fn initialize(
    program_id: &Pubkey,
    amm_id: &Pubkey,
    amm_authority: &Pubkey,
...
/// Creates a native rust 'deposit' instruction.
pub fn deposit(
    program_id: &Pubkey,
    amm_id: &Pubkey,
    amm_authority: &Pubkey,
...
/// Creates a native rust 'withdraw' instruction.
pub fn withdraw(
    program_id: &Pubkey,
    amm_id: &Pubkey,
    amm_authority: &Pubkey,
...
/// Creates a native rust 'swap_base_in' instruction.
pub fn swap_base_in(
    program_id: &Pubkey,
    amm_id: &Pubkey,
    amm_authority: &Pubkey,
...
/// Creates a native rust 'swap_base_out' instruction.
